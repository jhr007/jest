...
2. Jest uses [Yarn](https://code.facebook.com/posts/1840075619545360) for
   ...
   On **Windows** you'll also need some
   [other build tools](https://github.com/felixrieseberg/windows-build-tools)
   for yarn to install all the dependencies.
...
6. Ensure the test suite passes via `yarn test`. To run the test suite you may
   need to install [Mercurial](https://www.mercurial-scm.org/) (`hg`). On macOS,
   this can be done using [homebrew](http://brew.sh/): `brew install hg`.
